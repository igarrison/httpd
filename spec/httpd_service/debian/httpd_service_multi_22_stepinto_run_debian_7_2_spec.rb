...
describe 'httpd_service::multi 2.2 on debian-7.2' do
  ...
  context 'when compiling the recipe' do
    ...
    it 'creates user alice' do
      expect(debian_7_2_multi_stepinto_run).to create_user('alice')
        .with(
        gid: 'alice'
        )
    end
    ...
    it 'creates user bob' do
      expect(debian_7_2_multi_stepinto_run).to create_user('bob')
        .with(
        gid: 'bob'
        )
    end
    ...
    it 'creates httpd_service[instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_httpd_service('instance-1')
        .with(
    ...
    it 'creates httpd_service[instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_httpd_service('instance-2')
        .with(
  ...
  context 'when stepping into the httpd_service[default] resource' do
    ...
    it 'steps into httpd_service[default] and installs package[default :delete apache2]' do
      expect(debian_7_2_multi_stepinto_run).to install_package('default :delete apache2')
        .with(
    ...
    it 'does not run_bash[default :delete remove_package_config]' do
      expect(debian_7_2_multi_stepinto_run).to_not run_bash('default :delete remove_package_config')
        .with(
        user: 'root'
        )
    end
    ...
    it 'deletes directory[default :delete /var/cache/apache2]' do
      expect(debian_7_2_multi_stepinto_run).to delete_directory('default :delete /var/cache/apache2')
        .with(
    ...
    it 'deletes directory[default :delete /var/log/apache2]' do
      expect(debian_7_2_multi_stepinto_run).to delete_directory('default :delete /var/log/apache2')
        .with(
    ...
    it 'deletes directory[default :delete /var/run/apache2]' do
      expect(debian_7_2_multi_stepinto_run).to_not delete_directory('default :delete /var/run/apache2')
        .with(
    ...
    it 'deletes directory[default :delete /etc/apache2/conf.d]' do
      expect(debian_7_2_multi_stepinto_run).to delete_directory('default :delete /etc/apache2/conf.d')
        .with(
    ...
    it 'deletes directory[default :delete /etc/apache2/mods-available]' do
      expect(debian_7_2_multi_stepinto_run).to delete_directory('default :delete /etc/apache2/mods-available')
        .with(
    ...
    it 'deletes directory[default :delete /etc/apache2/mods-enabled]' do
      expect(debian_7_2_multi_stepinto_run).to delete_directory('default :delete /etc/apache2/mods-enabled')
        .with(
    ...
    it 'deletes directory[default :delete /etc/apache2/sites-available]' do
      expect(debian_7_2_multi_stepinto_run).to delete_directory('default :delete /etc/apache2/sites-available')
        .with(
    ...
    it 'deletes directory[default :delete /etc/apache2/sites-enabled]' do
      expect(debian_7_2_multi_stepinto_run).to delete_directory('default :delete /etc/apache2/sites-enabled')
        .with(
    ...
    it 'deletes file[default :delete /etc/apache2/mime.types]' do
      expect(debian_7_2_multi_stepinto_run).to delete_file('default :delete /etc/apache2/mime.types')
        .with(
  ...
  context 'when stepping into the httpd_service[instance-1] resource' do
    it 'steps into httpd_service[instance-1] and installs package[instance-1 :create apache2]' do
      expect(debian_7_2_multi_stepinto_run).to install_package('instance-1 :create apache2')
        .with(
        package_name: 'apache2'
        )
    end
    ...
    it 'does not run_bash[instance-1 :delete remove_package_config]' do
      expect(debian_7_2_multi_stepinto_run).to_not run_bash('instance-1 :create remove_package_config')
        .with(
        user: 'root'
        )
    end
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /var/cache/apache2-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /var/cache/apache2-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /var/log/apache2-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /var/log/apache2-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /var/run/apache2-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /var/run/apache2-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /etc/apache2-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /etc/apache2-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /etc/apache2-instance-1/conf.d]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /etc/apache2-instance-1/conf.d')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /etc/apache2-instance-1/mods-available]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /etc/apache2-instance-1/mods-available')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /etc/apache2-instance-1/mods-enabled]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /etc/apache2-instance-1/mods-enabled')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /etc/apache2-instance-1/sites-available]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /etc/apache2-instance-1/sites-available')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates directory[instance-1 :create /etc/apache2-instance-1/sites-enabled]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-1 :create /etc/apache2-instance-1/sites-enabled')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates template[instance-1 :create /etc/apache2-instance-1/envvars]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-1 :create /etc/apache2-instance-1/envvars')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates template[instance-1 :create /usr/sbin/a2enmod]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-1 :create /usr/sbin/a2enmod')
        .with(
        path: '/usr/sbin/a2enmod',
    ...
    it 'steps into httpd_service[instance-1] and creates link[instance-1 :create /usr/sbin/a2enmod-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to_not create_link('instance-1 :create /usr/sbin/a2enmod-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates link[instance-1 :create /usr/sbin/a2dismod-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_link('instance-1 :create /usr/sbin/a2dismod-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates link[instance-1 :create /usr/sbin/a2ensite-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_link('instance-1 :create /usr/sbin/a2ensite-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates link[instance-1 :create /usr/sbin/a2dissite-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_link('instance-1 :create /usr/sbin/a2dissite-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates template[instance-1 :create /etc/apache2-instance-1/mime.types]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-1 :create /etc/apache2-instance-1/mime.types')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and deletes file[instance-1 :create /etc/apache2-instance-1/ports.conf]' do
      expect(debian_7_2_multi_stepinto_run).to delete_file('instance-1 :create /etc/apache2-instance-1/ports.conf')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates template[instance-1 :create /etc/init.d/apache2-instance-1]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-1 :create /etc/init.d/apache2-instance-1')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and installs package[instance-1 :create apache2-mpm-prefork]' do
      expect(debian_7_2_multi_stepinto_run).to install_package('instance-1 :create apache2-mpm-prefork')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates httpd_config[instance-1 :create mpm_prefork]' do
      expect(debian_7_2_multi_stepinto_run).to create_httpd_config('instance-1 :create mpm_prefork')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and deletes httpd_config[instance-1 :create mpm_worker]' do
      expect(debian_7_2_multi_stepinto_run).to delete_httpd_config('instance-1 :create mpm_worker')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and deletes httpd_config[instance-1 :create mpm_event]' do
      expect(debian_7_2_multi_stepinto_run).to delete_httpd_config('instance-1 :create mpm_event')
        .with(
    ...
    it 'steps into httpd_service[instance-1] and creates template[instance-1 :create /etc/apache2-instance-1/apache2.conf]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-1 :create /etc/apache2-instance-1/apache2.conf')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates template[instance-2 :create /usr/sbin/a2enmod]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-2 :create /usr/sbin/a2enmod')
        .with(
        path: '/usr/sbin/a2enmod',
        source: '2.2/scripts/a2enmod.erb',
        owner: 'root',
    ...
    %w(
      ...
      it "steps into httpd_service[instance-1] and creates httpd_module[instance-1 :create #{mod}]" do
        expect(debian_7_2_multi_stepinto_run).to create_httpd_module("instance-1 :create #{mod}")
          .with(
          module_name: mod,
          instance: 'instance-1',
          httpd_version: '2.2'
  ...
  context 'when stepping into the httpd_service[instance-2] resource' do
    it 'steps into httpd_service[instance-2] and installs package[instance-2 :create apache2]' do
      expect(debian_7_2_multi_stepinto_run).to install_package('instance-2 :create apache2')
        .with(
        package_name: 'apache2'
        )
    end
    ...
    it 'does not run_bash[instance-2 :delete remove_package_config]' do
      expect(debian_7_2_multi_stepinto_run).to_not run_bash('instance-2 :create remove_package_config')
        .with(
        user: 'root'
        )
    end
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /var/cache/apache2-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /var/cache/apache2-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /var/log/apache2-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /var/log/apache2-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /var/run/apache2-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /var/run/apache2-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /etc/apache2-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /etc/apache2-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /etc/apache2-instance-2/conf.d]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /etc/apache2-instance-2/conf.d')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /etc/apache2-instance-2/mods-available]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /etc/apache2-instance-2/mods-available')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /etc/apache2-instance-2/mods-enabled]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /etc/apache2-instance-2/mods-enabled')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /etc/apache2-instance-2/sites-available]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /etc/apache2-instance-2/sites-available')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates directory[instance-2 :create /etc/apache2-instance-2/sites-enabled]' do
      expect(debian_7_2_multi_stepinto_run).to create_directory('instance-2 :create /etc/apache2-instance-2/sites-enabled')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates template[instance-2 :create /etc/apache2-instance-2/envvars]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-2 :create /etc/apache2-instance-2/envvars')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates link[instance-2 :create /usr/sbin/a2enmod-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to_not create_link('instance-2 :create /usr/sbin/a2enmod-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates link[instance-2 :create /usr/sbin/a2dismod-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_link('instance-2 :create /usr/sbin/a2dismod-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates link[instance-2 :create /usr/sbin/a2ensite-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_link('instance-2 :create /usr/sbin/a2ensite-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates link[instance-2 :create /usr/sbin/a2dissite-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_link('instance-2 :create /usr/sbin/a2dissite-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates template[instance-2 :create /etc/apache2-instance-2/mime.types]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-2 :create /etc/apache2-instance-2/mime.types')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and deletes file[instance-2 :create /etc/apache2-instance-2/ports.conf]' do
      expect(debian_7_2_multi_stepinto_run).to delete_file('instance-2 :create /etc/apache2-instance-2/ports.conf')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and creates template[instance-2 :create /etc/init.d/apache2-instance-2]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-2 :create /etc/init.d/apache2-instance-2')
        .with(
    ...
    it 'steps into httpd_service[instance-2] and installs package[instance-2 :create apache2-mpm-prefork]' do
      expect(debian_7_2_multi_stepinto_run).to install_package('instance-2 :create apache2-mpm-prefork')
        .with(
        package_name: 'apache2-mpm-prefork'
        )
    end
    ...
    it 'steps into httpd_service[instance-2] and creates httpd_config[instance-2 :create mpm_prefork]' do
      expect(debian_7_2_multi_stepinto_run).to create_httpd_config('instance-2 :create mpm_prefork')
        .with(
        config_name: 'mpm_prefork',
        instance: 'instance-2',
        source: 'mpm.conf.erb',
    ...
    it 'steps into httpd_service[instance-2] and deletes httpd_config[instance-2 :create mpm_worker]' do
      expect(debian_7_2_multi_stepinto_run).to delete_httpd_config('instance-2 :create mpm_worker')
        .with(
        config_name: 'mpm_worker',
        instance: 'instance-2'
        )
    ...
    it 'steps into httpd_service[instance-2] and deletes httpd_config[instance-2 :create mpm_event]' do
      expect(debian_7_2_multi_stepinto_run).to delete_httpd_config('instance-2 :create mpm_event')
        .with(
        config_name: 'mpm_event',
        instance: 'instance-2'
        )
    ...
    it 'steps into httpd_service[instance-2] and creates template[instance-2 :create /etc/apache2-instance-2/apache2.conf]' do
      expect(debian_7_2_multi_stepinto_run).to create_template('instance-2 :create /etc/apache2-instance-2/apache2.conf')
        .with(
    ...
    %w(
      ...
      it "steps into httpd_service[instance-2] and creates httpd_module[instance-2 :create #{mod}]" do
        expect(debian_7_2_multi_stepinto_run).to create_httpd_module("instance-2 :create #{mod}")
          .with(
          module_name: mod,
          instance: 'instance-2',
          httpd_version: '2.2'
