...
describe 'httpd_config::default' do
  ...
  context 'compiling the recipe' do
    it 'creates httpd_config[hello]' do
      expect(httpd_config_stepinto_run_centos_5_8).to create_httpd_config('hello')
    end

    it 'creates httpd_config[hello_again]' do
      expect(httpd_config_stepinto_run_centos_5_8).to create_httpd_config('hello_again')
    end
  end
